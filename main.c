...
Horario horario[7];
strcpy(horario[0]->dia,"Lunes");
strcpy(horario[1]->dia,"Martes");
strcpy(horario[2]->dia,"Miercoles");
strcpy(horario[3]->dia,"Jueves");
strcpy(horario[4]->dia,"Viernes");
strcpy(horario[5]->dia,"Sabado");
strcpy(horario[6]->dia,"Domingo");
